...
!(async () => {
  ...
  $.temp = [];
  $.updatePkActivityIdRes = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/sj.json')
  if (!$.updatePkActivityIdRes) {
    $.http.get({url: 'https://raw.fastgit.org/a592345029/backup/main/sj.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    $.updatePkActivityIdRes = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/sj.json')
  }
  await requireConfig();
