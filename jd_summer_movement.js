...
!(async () => {
  ...
  // 助力
  let res = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/sharecode.txt')
  if (!res) {
    $.http.get({url: 'https://raw.fastgit.org/a592345029/backup/main/sharecode.txt'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/sharecode.txt') || []
  }
  let res2 = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/sharecode.txtn')
  if (!res2) {
    $.http.get({url: 'https://raw.fastgit.org/a592345029/backup/main/sharecode.txt'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/sharecode.txt') || []
  }
  let res3 = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/sharecode.txt')
  if (!res3) {
    $.http.get({url: 'https://raw.fastgit.org/a592345029/backup/main/sharecode.txt'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res3 = await getAuthorShareCode('https://raw.fastgit.org/a592345029/backup/main/sharecode.txt') || []
  }
  if (ShHelpAuthorFlag) {
